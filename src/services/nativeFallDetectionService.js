/**
 * Native Fall Detection Service - TRUE 24/7 background fall detection
 * Uses direct WebView bridge to native Android foreground service
 * Works exactly like nativeStepService.js
 */
  ...
  startPolling() {
    ...
    this.pollInterval = setInterval(async () => {
      ...
      if (status.fallDetected) {
        ...
        // Reset flag after notifying
        await this.resetFallFlag();
      }
    }, 1000); // Poll every second for critical fall detection
  }
...
export const nativeFallDetectionService = new NativeFallDetectionService();
export default nativeFallDetectionService;
