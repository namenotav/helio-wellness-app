// Restaurant Database - Global Chains with 5,500+ Menu Items from 75+ Restaurants
...
export const restaurantDatabase = [
  ...
  },
  {
    ...
    menuItems: [
      ...
      { id: 'burrito-bean', name: 'Bean Burrito', category: 'Burritos', calories: 350, protein: 13, carbs: 54, fats: 10, sodium: 1000, serving_size: '198g' },
  ...
  },
  {
    ...
    menuItems: [
      ...
      { id: 'parmesan-bread-bites', name: 'Parmesan Bread Bites (16)', category: 'Sides', calories: 880, protein: 32, carbs: 112, fats: 32, sodium: 2000, serving_size: '320g' }
    ]
  },
  {
    id: 'littlecaesars-us',
  ...
  // ========== MORE US CHAINS ==========
  {
    ...
    menuItems: [
      ...
      { id: 'cheeseburger', name: 'Cheeseburger', category: 'Burgers', calories: 480, protein: 22, carbs: 39, fats: 27, sodium: 1000, serving_size: '268g' },
...
export function searchMenuItems(query, restaurantId = null, filters = {}) {
  let restaurants = restaurantId 
    ? restaurantDatabase.filter(r => r.id === restaurantId)
    : restaurantDatabase;
  ...
  restaurants.forEach(restaurant => {
    let matchingItems = restaurant.menuItems.filter(item => {
      ...
      const matchesText = !query || 
        ...
        (item.cuisine && item.cuisine.toLowerCase().includes(lowerQuery));
