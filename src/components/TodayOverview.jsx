...
export default function TodayOverview({ todaySteps = 0 }) {
  ...
  const loadStats = async () => {
    ...
    try {
      ...
      // 💧 Load water intake from localStorage (synced from Firestore)
      ...
      // 😴 Load sleep from localStorage (synced from Firestore)
      ...
      // 💪 Load workouts from localStorage (synced from Firestore)
