...
export default function ProfileTabRedesign({ 
  ...
  const loadUserData = async () => {
    try {
      ...
      // ✅ FIX: Get stats from Preferences + authService (not localStorage)
      const streakInfo = gamificationService.getStreakInfo()
      
      // Workout history from Preferences first
      let workoutHistory = []
      try {
      ...
      // ✅ Check for newly unlocked achievements (after data sync)
      try {
