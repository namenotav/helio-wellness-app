import { Z as commonjsGlobal, $ as _typeof$1, a0 as getDefaultExportFromCjs } from "./entry-1767948920134-index.js";
var es_promise = {};
...
function requireGlobal() {
  ...
  global = // eslint-disable-next-line es/no-global-this -- safe
...
function requireRequireObjectCoercible() {
  ...
  requireObjectCoercible = function(it) {
    if (isNullOrUndefined2(it)) throw $TypeError("Can't call method on " + it);
    return it;
  };
...
function requireACallable() {
  ...
  aCallable = function(argument) {
    ...
    throw $TypeError(tryToString2(argument) + " is not a function");
  };
  return aCallable;
}
var getMethod;
...
function require_export() {
  ...
  _export = function(options, source) {
    ...
    if (GLOBAL) {
      ...
      target = global2[TARGET] || defineGlobalProperty2(TARGET, {});
    } else {
...
function requireAConstructor() {
  ...
  aConstructor = function(argument) {
    ...
    throw $TypeError(tryToString2(argument) + " is not a constructor");
  };
  return aConstructor;
}
...
function requireTask() {
  ...
  if (!set || !clear) {
    ...
    } else if (global2.addEventListener && isCallable2(global2.postMessage) && !global2.importScripts && $location && $location.protocol !== "file:" && !fails2(globalPostMessageDefer)) {
...
function requirePromiseNativeConstructor() {
  ...
  var global2 = requireGlobal();
  promiseNativeConstructor = global2.Promise;
...
function requireEngineIsBrowser() {
  ...
  var IS_NODE = requireEngineIsNode();
  engineIsBrowser = !IS_DENO && !IS_NODE && typeof window == "object" && typeof document == "object";
...
function requirePromiseConstructorDetection() {
  ...
  var NATIVE_PROMISE_REJECTION_EVENT = isCallable2(global2.PromiseRejectionEvent);
...
function requireGetIterator() {
  ...
  getIterator = function(argument, usingIterator) {
    ...
    throw $TypeError(tryToString2(argument) + " is not iterable");
  };
  return getIterator;
}
var iteratorClose;
...
function requireIterate() {
  ...
  iterate = function(iterable, unboundFunction, options) {
    ...
    if (IS_RECORD) {
      ...
      if (!iterFn) throw $TypeError(tryToString2(iterable) + " is not iterable");
...
function requireToString() {
  ...
  toString = function(argument) {
    if (classof2(argument) === "Symbol") throw TypeError("Cannot convert a Symbol value to a string");
    return $String(argument);
  };
  return toString;
}
...
function requireEs_array_iterator() {
  ...
  es_array_iterator = defineIterator(Array, "Array", function(iterated, kind) {
    ...
    if (kind == "keys") return createIterResultObject2(index2, false);
    if (kind == "values") return createIterResultObject2(target[index2], false);
  ...
  var handlePrototype = function(CollectionPrototype, COLLECTION_NAME2) {
    if (CollectionPrototype) {
      ...
      if (!CollectionPrototype[TO_STRING_TAG]) {
        createNonEnumerableProperty2(CollectionPrototype, TO_STRING_TAG, COLLECTION_NAME2);
      }
...
function requireCreateProperty() {
  ...
  createProperty = function(object, key, value) {
    ...
    if (propertyKey in object) definePropertyModule.f(object, propertyKey, createPropertyDescriptor2(0, value));
  ...
  fixRegExpWellKnownSymbolLogic("split", function(SPLIT, nativeSplit, maybeCallNative) {
    ...
    ".".split(/()()/).length > 1 || "".split(/.?/).length) {
      internalSplit = function(separator, limit) {
        ...
        while (match = call(regexpExec2, separatorCopy, string)) {
          lastIndex = separatorCopy.lastIndex;
          if (lastIndex > lastLastIndex) {
            push(output, stringSlice(string, lastLastIndex, match.index));
            if (match.length > 1 && match.index < string.length) apply($push, output, arraySlice2(match, 1));
...
function requireEs_regexp_toString() {
  ...
  if (NOT_GENERIC || INCORRECT_NAME) {
    defineBuiltIn2(RegExp.prototype, TO_STRING, function toString2() {
